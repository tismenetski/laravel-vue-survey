...
const {question,index,modelValue} =  defineProps({
    question : Object,
    index : Number,
    modelValue : [String,Array] // Example for a v-model that is passed as a prop,  to access v-model prop we use modelValue
})

const emits = defineEmits(['update:modelValue']); // this completes the two way binding for the passed prop
